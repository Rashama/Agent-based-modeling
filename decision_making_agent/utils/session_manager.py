...
def initialize_session_state():
    ...
    valid_screens = {
        ...
        "display_ideas"  # ✅ Add this missing screen
    }
    ...
    # Keep URL in sync wi`th current screen
    ...
    defaults = {
        ...
        "resubmitted_idea": "",  # ✅ comma here
        "saved_id1": None,       # ✅ now safe
        "saved_id2": None        # ✅ now safe
    }
