        ...
        with col2:
            st.markdown(
                ...
                <div class="question-container">
                    <h1 class="question-header">Informational AI Manager</h1>
            ...
            with st.container():
                ...
                """, unsafe_allow_html=True)
                st.session_state.user_idea = st.text_area(label="enter your idea", key="practice_idea_input", height=150)
            ...
            if st.button("Submit", key="next_button"):
                ...
                if idea and idea != st.session_state.last_idea_submitted:
                    ...
                    with st.spinner("Saving idea and generating response..."):
                        update_idea_by_id(st.session_state.user_id, idea,None,"information_agent")
                        get_ai_response()
