    ...
    st.markdown(
        ...
        <div class="instruction-container">
            ...
            <p class="instruction-text">
                We are conducting an experiment to examine how Artificial Intelligence (AI) managers influence individual performance. In this experiment, you will generate ideas for various situations and will be managed by an Informational AI manager.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
