...
from utils.utils import display_ai_response
...
def main():
    ...
    if st.session_state.session_completed:
        # print("####################calling survery page function:")
        display_survey_page()
    ...
    if st.session_state.current_screen == "consent_form":
        ...
        display_ai_response(image_path,"ai_response")

    # elif st.session_state.current_screen == "resubmit":
    #     # print("###########################in resubmit condition elif")
